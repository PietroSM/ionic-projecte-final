...
@Component({
  ...
  standalone: true,
  imports: [IonCol, IonRow, IonImg, IonBackButton, IonButtons, IonIcon, IonItem, IonLabel, IonButton, IonBadge, IonCardTitle, IonCard, IonCardHeader, IonCardSubtitle, IonCardContent, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
